        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="p_addsubcategory.php"><i class="fa fa-circle-o"></i> Add Sub-Category</a></li>
                                <li><a href="p_getsubcategory.php"><i class="fa fa-circle-o"></i> Modify Sub-Category</a></li>
                                <li><a href="p_addproduct.php"><i class="fa fa-circle-o"></i> Add Product</a></li>
                                <li><a href="edit_cd_category.php"><i class="fa fa-circle-o"></i> Modify Product</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="p_addsubcategory.php" role="form" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control input-lg" name="subcategory_name" placeholder="Sub-Category Name" required maxlength="50">
                                ...
                                <div class="form-group has-feedback">
                                    <select class="form-control input-lg" name="category_id" required>
                                        ...
                                        while ($fetch_category_query = mysqli_fetch_assoc($query)) {
                                            ...
                                            echo $fetch_category_query["category"];
                                            echo'</option>';
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group has-feedback">
                                    <textarea  class="form-control input-lg" name="subcategory_description" placeholder="Sub-Category Description (Optional)" rows="5" maxlength="200"></textarea>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subcategory_name = mysqli_real_escape_string($connect, filter_input(INPUT_POST, "subcategory_name"));
    $subcategory_description = mysqli_real_escape_string($connect, filter_input(INPUT_POST, "subcategory_description"));
    $query = mysqli_query($connect, "call spaddsubcategory('$category_id', '$subcategory_name', '$subcategory_description')");
    //echo $query;
    if ($query) {
        ?>
        <script>
