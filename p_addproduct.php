        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="p_addproduct.php"><i class="fa fa-circle-o"></i> Add Product</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="p_addproduct.php" role="form" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control input-lg" name="product_name" placeholder="Product Name" required maxlength="50">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group has-feedback">
                                    <select class="form-control input-lg" name="subcategory_id" required>
                                        ...
                                        <?php
                                        include 'p_connect.php';
                                        $query = mysqli_query($connect, "CALL spgetsubcategory('0','0')");
                            ...
                            <div class="col-sm-12">
                                <div class="form-group has-feedback">
                                    <textarea  class="form-control input-lg" name="product_description" placeholder="Product Description (Optional)" rows="5" maxlength="200"></textarea>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $product_name = mysqli_real_escape_string($connect, filter_input(INPUT_POST, "product_name"));
    $product_description = mysqli_real_escape_string($connect, filter_input(INPUT_POST, "product_description"));
    $query = mysqli_query($connect, "call spaddproduct('$category_id', '$subcategory_id' ,'$product_name', '$product_description')");
    //echo $query;
    if ($query) {
        ?>
        <script>
