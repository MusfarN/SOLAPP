                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="p_getcategory.php"><i class="fa fa-circle-o"></i> Modify Category</a></li>
                ...
                <section class="content">
                    <form action="p_getcategory.php" role="form" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-xs-4">
                                <input type="text" name="action" value="fetchcategory" hidden="">
                                        ...
                                        <div class="box-body">
                                            <table id="added-bayanaat" class="table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($connect, "CALL spgetcategory('$category_id')");
                                                    $counter = 0;
                                                    while ($fetch_category = mysqli_fetch_assoc($query)) {
                                                        ?>
                                                        <tr>
                                                            <td><?php echo ++$counter . "."; ?></td>
                                                            <td><?php echo $fetch_category["category"]; ?></td>
                                                            <td><?php echo $fetch_category["description"]; ?></td>
                                                            <td><button class="btn btn-primary EditCategory" value="<?php echo $fetch_category["categoryID"]; ?>" data-toggle="modal" data-target="#modifyModal"><i class = "fa fa-edit"></i> Edit</button></td>
                                                            <td><button class="btn btn-danger DeleteCategory" value="<?php echo $fetch_category["categoryID"]; ?>" ><i class = "fa fa-trash"></i> Delete</button></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
